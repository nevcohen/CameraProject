...
public class SphereTests {
	...
	public void testFindIntersections() {
		...
		result = sphere.findIntersections(new Ray(new Point3D(0.5, 1, 0), new Vector(0, 1, 0)));
		...
		// center line
		result = sphere.findIntersections(new Ray(new Point3D(1, 2, 0), new Vector(1, 0, 0)));
		assertEquals("Wrong number of points", 0, result.size());		
	}
